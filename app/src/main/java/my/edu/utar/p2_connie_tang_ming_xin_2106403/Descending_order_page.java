...
public class Descending_order_page extends AppCompatActivity {

    private TextView descendingTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_descending_order_page);

        Guideline = findViewById(R.id.guideline);
        Guideline.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Descending_order_page. this, Q3_guideline_page.class);
                startActivity(intent);
            }
        });

        descendingTextView = findViewById(R.id.descending_answer);
    ...
    private void handleCardClick(int cardNumber) {
        ...
        if (currentIndex == 0) {
            descendingTextView.setText(String.valueOf(selectedNumber));
        } else {
            descendingTextView.append(", " + selectedNumber);
        }
    ...
    private void startNewQuestion() {
        ...
        descendingTextView.setText(""); // Reset descendingTextView
    ...
    private void endTest() {
        ...
        if (score > previousHighestDescendingScore) {
            // Update highest descending score if current score is higher
            highestScore = score;
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt("highestDescendingScore", highestScore);
            editor.apply();
        }
        ...
        alertDialogBuilder.setMessage("Test Name: Ordering of Numbers - Descending order\n" +
                "Highest Score Before: " + previousHighestDescendingScore + "\n" +
        ...
        alertDialogBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent intent = new Intent(Descending_order_page.this, Home_page.class);
                startActivity(intent);
